...
const projectsData = [
  {
    ...
    challenges:
      "Desenvolvimento de um sistema robusto de reservas que evita conflitos de agendamento e oferece uma experiência fluida tanto para clientes quanto para administradores.",
    results:
      "Aumento de 40% nas reservas online e redução de 60% no tempo de gestão administrativa.",
    duration: "3 meses",
  ...
  },
  {
    ...
    challenges:
      "Criar uma interface que apresente dados complexos de forma clara e permita ação rápida em caso de problemas na infraestrutura.",
    results:
      "Redução de 75% no tempo de detecção de problemas e melhoria significativa na disponibilidade dos serviços.",
    duration: "2 meses",
  ...
  },
  {
    ...
    challenges:
      "Desenvolver uma solução de pagamentos segura e confiável que atenda às necessidades de pequenos prestadores de serviço locais.",
    results:
      "Processamento de mais de R$ 50.000 em transações no primeiro mês e feedback 100% positivo dos usuários.",
    duration: "4 meses",
...
function App() {
    ...
    const initThreeJS = () => {
      ...
      const animate = () => {
        ...
        shapes.forEach((shape) => {
          ...
          // Add floating motion
          shape.position.y +=
            Math.sin(Date.now() * 0.001 + shape.position.x) * 0.01;
        });
        ...
        <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          <div className="relative">
            ...
            <div className="absolute bottom-4 left-6">
              <span
                className={`${project.categoryColor} text-white text-sm font-medium px-3 py-1 rounded-full`}
              >
                {project.category}
              </span>
            </div>
  ...
  const HeroSection = () => {
    ...
    return (
      <section
        id="home"
        className="min-h-screen flex items-center pt-20 perspective relative"
      >
        <div className="container mx-auto px-6 py-20 md:py-32 flex flex-col md:flex-row items-center relative z-10">
          <div ref={heroTextRef} className="md:w-1/2 mb-12 md:mb-0 opacity-0">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-lg">
              Sou um desenvolvedor de soluções digitais com anos de experiência
              criando aplicações inovadoras e impactantes para clientes em
              diversos setores.
            </p>
  ...
  return (
    <div className="font-sans bg-gray-50 text-gray-800 overflow-x-hidden">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Domínio técnico e experiência prática nas principais tecnologias
              do mercado.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card-3d bg-white p-8 rounded-xl">
              ...
              <p className="text-gray-600 mb-4">
                Criação de aplicações React modernas e responsivas com as
            ...
            <div className="card-3d bg-white p-8 rounded-xl">
              ...
              <p className="text-gray-600 mb-4">
                Conectando sistemas através de APIs REST e GraphQL com
                eficiência.
              </p>
              <div className="skill-bar">
            ...
            <div className="card-3d bg-white p-8 rounded-xl">
              ...
              <p className="text-gray-600 mb-4">
                Desenvolvimento de soluções automatizadas para otimizar
                processos.
              </p>
              <div className="skill-bar">
            ...
            <div className="card-3d bg-white p-8 rounded-xl">
              ...
              <p className="text-gray-600 mb-4">
                Design de interfaces intuitivas e experiências de usuário
                memoráveis.
              </p>
              <div className="skill-bar">
      ...
      <section id="projects" className="py-20 relative z-10">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Alguns dos trabalhos que realizei para clientes e projetos
              pessoais.
            </p>
          </div>
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 p-6">
                    <span
                      className={`${project.categoryColor} text-white text-xs font-medium px-2.5 py-0.5 rounded`}
                    >
                      {project.category}
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="testimonial-card p-8 rounded-xl shadow-md backdrop-blur-sm hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-700 italic mb-6 leading-relaxed">
                "Trabalhar com o Celso foi uma experiência incrível. Entregou
                nosso projeto antes do prazo e com qualidade excepcional.
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-600 text-sm">
                    Diretor, DigitalAgency
                  </p>
                </div>
              </div>
              <p className="text-gray-700 italic mb-6 leading-relaxed">
                "Profissional altamente qualificado e comprometido. Sua
                capacidade de resolver problemas complexos é impressionante.
                Nosso projeto teve um aumento de 40% nas conversões."
              </p>
              <div className="flex text-yellow-400">
                <i className="fas fa-star"></i>
                <i className="fas fa-star"></i>
            ...
            <div className="testimonial-card p-8 rounded-xl shadow-md backdrop-blur-sm hover:shadow-lg transition-all duration-300 md:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-700 italic mb-6 leading-relaxed">
                "Excelente comunicação e profissionalismo. Entendeu
                perfeitamente nossas necessidades e entregou uma solução que
      ...
      <section
        id="contact"
        className="py-20 bg-gradient-to-br from-blue-50 to-purple-50 relative z-10"
      >
        <div className="container mx-auto px-6">
              ...
              <div className="md:w-1/2 bg-gradient-to-br from-blue-500 to-purple-600 p-8 text-white">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <i className="fas fa-envelope mt-14"></i>
                    <div>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  <div>
                    ...
                    <input
                      type="text"
                      id="name"
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-300"
                    />
                  </div>
                  <div>
                    <label
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="mb-4">
                Desenvolvedor dedicado a criar soluções digitais inovadoras e
                impactantes.
              </p>
              <div className="flex space-x-4">
                <a
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p>
              &copy; 2024 Celso L. Cavalheiro. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
